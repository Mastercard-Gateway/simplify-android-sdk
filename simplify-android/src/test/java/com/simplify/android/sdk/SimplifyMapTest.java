...
public class SimplifyMapTest {
    ...
    public void allConstructorsWork() {
        ...
        testMap(new SimplifyMap(), 0);
        testMap(new SimplifyMap(10, 1.4f), 0);
        testMap(new SimplifyMap(20), 0);

        Map map = new HashMap();
        map.put("k1", 9);
        map.put("k9", 99);
        SimplifyMap pm = new SimplifyMap(map);
        assert pm.size() == 2;
    ...
    private void testMap(SimplifyMap m, int size) {
        assert m.size() == size;
        m.put("k1", 1);
        m.put("k2.k3", 2);
        m.put("k4.k5.k6", 3);
    ...
    public void testJsonConstructorWithMap() {
        ...
        SimplifyMap map = new SimplifyMap(json);
    ...
    public void keyValueConstructorAddsKey() {
        assertEquals(new SimplifyMap("k1", "v1").get("k1"), "v1");
        assertEquals(new SimplifyMap("k1.k2", "v12").get("k1.k2"), "v12");
    }
    ...
    public void normalizeMapConvertsObjects() {
        ...
        Map<String, Object> n = SimplifyMap.normalize(m);
